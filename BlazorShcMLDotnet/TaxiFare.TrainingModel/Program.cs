...
namespace TaxiFare.TrainingModel
{
    internal static class Program
    {
        ...
        private static void TestSinglePrediction(MLContext mlContext)
        {
            ...
            SentimentIssue sentimentIssue = new SentimentIssue { Text = "This is a very rude movie" };
            ...
            Console.WriteLine($"Text: {sentimentIssue.Text} | Prediction: {(Convert.ToBoolean(resultprediction.Prediction) ? "Toxic" : "Nice")} sentiment | Probability: {resultprediction.Probability} ");
            Console.WriteLine($"==================================================");
            //
        }
    }
